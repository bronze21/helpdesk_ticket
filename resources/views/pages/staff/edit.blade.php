...
<div class="links h-100">
	<ul class="nav h-100">
		...
		<li class="nav-item">
			<a href="{{route('staff.index')}}" class="nav-link text-dark">
	...
	<div class="card">
		<div class="card-body">
			<div class="row justify-content-md-center h-100">
				<div class="col-12">
					<form action="{{route('staff.update',$data->id)}}" method="post" class="main-form position-relative h-100" x-watch="isFormValid('required')">
...
<div class="modal fade" id="mdl-change_password" x-watch="option.change_password">
	<form class="modal-dialog modal-dialog-centered" role="document" action="{{route('staff.update_password',$data->id)}}" method="post" x-watch="isFormValid('change_password')">
		@csrf
